...
#ifdef SCELL_COMPAT
static themis_status_t themis_auth_sym_derive_decryption_key_compat(
    const uint8_t* key,
    size_t key_length,
    const uint8_t* user_context,
    size_t user_context_length,
                                                 ...
                                                 size_t* message_length)
{
    ...
    res = themis_auth_sym_derive_decryption_key(key,
                                                key_length,
                                                user_context,
                                                user_context_length,
                                                &hdr,
    ...
    if (res != THEMIS_SUCCESS && res != THEMIS_BUFFER_TOO_SMALL) {
        res = themis_auth_sym_derive_decryption_key_compat(key,
                                                           key_length,
                                                           user_context,
                                                           user_context_length,
                                                           &hdr,
